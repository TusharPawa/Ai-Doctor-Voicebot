...
|---------|----------|
| 🎧 **User Audio:**<br><audio controls><source src="https://raw.githubusercontent.com/TusharPawa/Ai-Doctor-Voicebot/main/Outputs/Input.mp3" type="audio/mpeg">Your browser does not support the audio element.</audio> | 🎧 **Model (Doctor) Audio:**<br><audio controls><source src="https://raw.githubusercontent.com/TusharPawa/Ai-Doctor-Voicebot/main/Outputs/Output.mp3" type="audio/mpeg">Your browser does not support the audio element.</audio> |
