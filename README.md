  ...
  <tbody>
    <tr>
      <td>
        ...
        🎙️ <strong>User Input Audio</strong><br>
        <audio controls>
          <source src="https://github.com/TusharPawa/Ai-Doctor-Voicebot/raw/main/Outputs/Input.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
        </audio>
      </td>
      <td>
        <img src="https://github.com/TusharPawa/Ai-Doctor-Voicebot/blob/main/Outputs/Ouput.jpg?raw=true" width="450"/><br><br>
        🔈 <strong>Output Audio Generated by Model</strong><br>
        <audio controls>
          <source src="https://github.com/TusharPawa/Ai-Doctor-Voicebot/raw/main/Outputs/Output.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
        </audio>
      </td>
    </tr>
